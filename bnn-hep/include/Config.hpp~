...
class Config
{
	...
	string const & GetPyFileName() const;
	...
	std::vector<std::string> GetRootFiles();
    ...
    private:
        ...
        string networkPYFileName;  ///< Name of the output file to store C++ code of BNN
